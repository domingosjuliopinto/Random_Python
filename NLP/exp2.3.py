class PorterStemmer:
    ...
    def step1b(self, word):
        ...
        if flag:
            if word.endswith('at') or word.endswith('bl')or word.endswith('iz')or word.endswith('yp'):
                word += 'e'
            elif self.doubleCons(word) and not self.endsWith(word, 'l')and not self.endsWith(word, 's') and not self.endsWith(word, 'z') and self.lasttwo(word):
                word = word[:-1]
...
newporter = PorterStemmer()
list = []
n = int(input("Number of words you want to stem : "))
for i in range(n):
    word = input()
    list.append(word)
    
for word in list:
  print(newporter.stem(word))

"""
print(newporter.stem('hashing'))
print(newporter.stem('crying'))
print(newporter.stem('dragging'))
print(newporter.stem('playing'))
print(newporter.stem('typing'))
print(newporter.stem('writing'))
"""
